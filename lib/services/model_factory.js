...
function createModel(config) {
  ...
  var BaseModel = {
    ...
    deserialize: function(data) {
      return JSON.parse(config.entity, data);
    },
    ...
    serialize: function(data) {
      return JSON.stringify(config.entity, data);
    }
  };
